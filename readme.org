...
** pt-20191128-test1 - add test1() - simple schematic containing two code parts that outputs on schematic's output
   step towards reuse - gives simple test of reuse
